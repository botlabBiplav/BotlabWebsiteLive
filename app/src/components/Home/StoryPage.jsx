  ...
  return (
    ...
    <div>
      ...
      {/* <SimpleParallax scale={0.5} delay={0} overflow="true">
        ...
        <div className="text-white lg:text-6xl relative w-screen  bg-gradient-to-b from-black">
            <div className="pb-10 sm:pt-40">
                  <div className="flex justify-start lg:mx-80 mx-10 select-none">
                    <div className="mt-5 sm:w-1/2">
                      <p className="text-white lg:text-4xl text-2xl tracking-widest font-lexend">
                        TRANSFORMING THROUGH <span className="font-golden-hopes lg:text-9xl text-6xl text-[#8409FF]"> Innovation </span>
                      </p>
                      <p className="text-white lg:text-4xl text-2xl mt-8 w-auto max-w-fit font-lato font-light">
                  ...
                  <div className="flex justify-center lg:mt-36 lg:mx-80 mx-10 select-none">
                    <div className="sm:w-1/2 h-auto"></div>
                    <div className="sm:w-1/2 mt-5">
                      <p className="text-white lg:text-4xl text-2xl tracking-widest w-auto font-lexend">
                        TAILORED WITH <span className="font-golden-hopes lg:text-9xl text-6xl text-[#8409FF]"> Precision</span>
                      </p>
                      <p className="text-white lg:text-4xl text-2xl mt-2 w-auto max-w-fit font-lato font-light">
                  ...
                  <div className="flex justify-end lg:mt-36 lg:mx-80 mx-10 select-none">
                    <div className="mt-5 lg:w-1/2">
                      <p className="text-white lg:text-4xl text-2xl tracking-widest w-auto font-lexend">
                        MARKETING USING <span className="font-golden-hopes lg:text-9xl text-6xl text-[#8409FF]">  Storytelling</span>
                      </p>
                      <p className="text-white mt-2 lg:text-4xl text-2xl w-auto max-w-fit font-lato font-light">
                    ...
                    <div className="lg:w-1/2 h-auto"></div>
                  </div>
                </div>
            </div>
    </div>
