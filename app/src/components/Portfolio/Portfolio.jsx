        ...
        <div className="mt-44">
            {PortfolioData.map((item, index) => (
                <div key={index} className="mb-10 xl:ml-72 lg:ml-48 md:ml-36">
                    ...
                    {item.subtitle3 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-5">{item.subtitle3}</p>}
                    {item.subtitle4 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-5">{item.subtitle4}</p>}


                    {item.Title4 && <h1 className="text-white lg:text-4xl text-xl font-lexend ml-16">{item.Title4}</h1>}
                    {item.description1 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-3 ml-16">{item.description1}</p>}
                    ...
                    {item.description2 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-3 ml-16">{item.description2}</p>}
                    <div className="">
                        {item.Title6 && <h1 className="text-white text-2xl font- mt-10 ml-16">{item.Title6}</h1>}
                        {item.description3 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-2 ml-16">{item.description3}</p>}
                    </div>

                    <div className="">
                        {item.Title7 && <h1 className="text-white text-2xl font- mt-10 ml-16">{item.Title7}</h1>}
                        {item.description4 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 m-2 ml-16">{item.description4}</p>}
                        {item.subtitle5 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-10">{item.subtitle5}</p>}
                        {item.subtitle6 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-3">{item.subtitle6}</p>}
                    </div>
                    <div>
                ...
                <a data-src="https://botlab-website.s3.us-west-2.amazonaws.com/Rectangle+260.png">
                  ...
                  />
                    ...
                    <div>
                        ...
                        {item.subtitle8 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-5">{item.subtitle8}</p>}
                        {item.subtitle9 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-5">{item.subtitle9}</p>}
                        {item.subtitle20 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-5">{item.subtitle20}</p>}
                    </div>
                    <div>
                        {item.Title10 && <h1 className="text-white text-2xl font-lato">{item.Title10}</h1>}
                        {item.subtitle10 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 mt-1">{item.subtitle10}</p>}
                        {item.subtitle11 && <p className="text-gray-400 font-lexend text-[15px] w-2/3 -mt-1">{item.subtitle11}</p>}
